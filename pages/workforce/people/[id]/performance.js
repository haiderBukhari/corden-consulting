...
const MemberPerformance = () => {
  ...
  return (
    <Layout title={'Team'} subtitle={`Member List > ${member?.name} > Performance Review`}>
      <PerformanceComponent role={user.role} id={id} />
    </Layout>
  )
}
export default withAuth(MemberPerformance, ['team_lead', 'manager','HR']);
