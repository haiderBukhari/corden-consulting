...
const LoanDetail = () => {
  ...
  return (
    <Layout title={"Loan Details"} subtitle={"Overview"}>
      <LoanDetailPage mode="personal" role={user?.role} loanDetails={loanDetails} user={userProfile} ConfigurationData={ConfigurationData}/>
    </Layout>
  );
};

export default withAuth(LoanDetail, ['team_lead', 'staff', 'manager', 'HR', 'admin']);