...
const WorkforceAdvanceSalaryDashboard  = () => {
    ...
    <>
      <Layout title={"Advance Salary"} subtitle={"Overview"}>
        {isLoading || isLoadingUserprofile || isConfigLoading ? (
          ...
          <AdvanceSalaryDashboard mode="workforce" role={user.role} user={userProfile} isApproverOne={isApproverOne} />
        )}
      </Layout>
...
export default withAuth(WorkforceAdvanceSalaryDashboard , ["manager"]);
