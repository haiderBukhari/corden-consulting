...
export default function UseUpdateSalaryConfigration() {
  ...
  const updateLoanRequest = async (data) => {
    ...
    return await axios.post(
      `https://hr-backend-talo.com/api/early-salary/save-update-configuration/1`,
      data,
      {
        headers: {
  ...
  return useMutation(updateLoanRequest, {
    onSuccess: async (res, variables, context) => {
      ...
      successToaster("Salary Configration Updated Successfully");
    },
