...
export default function UseDeletePayroll() {
  const queryClient = useQueryClient()

  const deletePayrollRequest = async (id) => {
    ...
    return await axios.get(
      `https://hr-backend-talo.com/api/delete-payrol/${id}`,
  ...
  return useMutation(deletePayrollRequest, {
    onSuccess: async (res, variables, context) => {
      ...
      successToaster("Payroll Deleted  Successfully");
    },
    onError: (err, variables, context) => {
      let errorMessage = "Error in Deleting payroll!";
