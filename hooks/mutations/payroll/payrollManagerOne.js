...
export default function UsePayrollManagerOne() {
  const queryClient = useQueryClient()

  const managerOnePayroll = async ({ payrollId, formData }) => {
    ...
    return await axios.post(
      `https://hr-backend-talo.com/api/payroll-requests/manager-one/status/${payrollId}`,
      formData,
      {
        headers: {
  ...
  return useMutation(managerOnePayroll, {
