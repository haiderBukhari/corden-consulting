...
export default function UseDeleteLoanRequest() {
  ...
  return useMutation(deleteLoanRequest, {
    onSuccess: async (res, variables, context) => {
      successToaster("Loan Request Deleted Successfully!")
      queryClient.refetchQueries(['userLoanList'])
    },
    onError: (err, variables, context) => {
      let errorMessage = "Error in deleting loan request!";
