...
export default function UsePayrollManagerThree() {
  const queryClient = useQueryClient()

  const managerThreePayroll = async ({ payrollId, formData }) => {
    ...
    return await axios.post(
      `https://hr-backend-talo.com/api/payroll-requests/manager-three/status/${payrollId}`,
      formData,
      {
        headers: {
  ...
  return useMutation(managerThreePayroll, {
