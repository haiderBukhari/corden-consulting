...
import { UseGetLocationAttendanceMonthlyReport } from '../../../hooks/query/locations/getLocationAttendanceMonthlyReport';
...
export default function LocationAttendanceReport({ role, managedLocations }) {
  ...
  const { data: reportData, isLoading, refetch } = UseGetLocationAttendanceMonthlyReport(selectedLocationId, formattedStartDate, formattedEndDate);
  ...
  return (
    <div>
      <div className="flex items-center gap-4 p-3">
        <label htmlFor="locationSelect" className="font-bold">Select Location:</label>
        <select
          id="locationSelect"
